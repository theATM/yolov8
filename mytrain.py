...
# On RSD + DOTA:
results = model.train(data="./datasets/RSD-YOLO-DOTANA-T/rds-yolo-dotana-t.yaml", epochs=100,batch=32,workers=128,freeze=0,coco_annot='./datasets/RSD-YOLO-DOTANA-T/valid/instances_val.json',
                      save_json=True, box_fusion='soft-nms')

# evaluate model performance on the validation set
results = model.val(save_json=True,plots=True, box_fusion='soft-nms')
